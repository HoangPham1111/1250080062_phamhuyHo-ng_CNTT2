...
class NhanVien extends ConNguoi {
    ...
    public void nhap() {
        ...
        try {
            ...
            this.ngayNhanViec = sdf.parse(ngayStr);
        } catch (ParseException e) {
            System.out.println("Ngay khong dung dinh dang!");
            this.ngayNhanViec = new Date(); // Gan ngay hien tai
        }
    ...
    public void xuat() {
        ...
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        String ngayStr = ngayNhanViec != null ? sdf.format(ngayNhanViec) : "Chua co";
        System.out.println("Ngay nhan viec: " + ngayStr);
        if (phongKhoaBan != null) {
            phongKhoaBan.xuat();
        }
    }
}
